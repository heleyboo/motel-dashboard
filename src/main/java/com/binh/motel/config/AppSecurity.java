...
//		http.authorizeRequests().antMatchers("/**").permitAll();
		http.authorizeRequests()
				...
				.antMatchers("/administrator/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGER', 'ROLE_STAFF')")
				.antMatchers("/administrator/store/**").access("hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGER')")
